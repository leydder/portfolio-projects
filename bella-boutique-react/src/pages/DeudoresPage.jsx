...
const styles = {
  ...
  statVal: { fontSize: '26px', fontWeight: '800', color: '#1a1a2e', margin: 0 },
  ...
  avatar: { width: '48px', height: '48px', background: '#1a1a2e', color: '#fff', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800', fontSize: '20px', flexShrink: 0 },
  buyerName: { fontWeight: '700', color: '#1a1a2e', fontSize: '16px', margin: '0 0 3px' },
  ...
  infoChip: { background: '#f8f7f4', borderRadius: '8px', padding: '6px 12px', fontSize: '12px', color: '#555' },
  ...
  itemChip: { background: '#f0ede8', color: '#1a1a2e', fontSize: '12px', fontWeight: '600', padding: '4px 10px', borderRadius: '10px' },
  ...
  cuotaAmount: { fontWeight: '700', color: '#1a1a2e', fontSize: '14px' },
  cuotaDate: { fontSize: '12px', color: '#888' },
  cuotaNota: { fontSize: '12px', color: '#aaa', fontStyle: 'italic' },
  btnPagar: { padding: '7px 16px', background: '#1a1a2e', color: '#fff', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '12px', flexShrink: 0 },
